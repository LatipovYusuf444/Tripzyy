...
export default function Contact() {
  ...
  const copy = {
    uz: {
      ...
      chips: [
        { label: "Telefon", value: "+998 format", icon: Phone },
      ...
      backendOff: "Backend ulanmagan",
      backendNote: "Bu bo'lim uchun real submit endpoint hali ulanmagan.",
      message: "Xabar",
      send: "Yuborish",
    ...
    en: {
      cards: [
        ...
        { icon: Clock, title: "Working hours", value: "09:00 - 23:00", note: "Online support continues" },
      ],
      badge: "Contact center",
      titleA: "Write for",
      titleB: "contact",
      ...
      ready: "Ready",
      checking: "Checking",
      backendOff: "Backend not connected",
      backendNote: "A real submit endpoint is not connected for this section yet.",
      message: "Message",
      send: "Send",
      ...
      moreTexts: [
        ...
        "This form is not connected to backend yet and does not send a real API request.",
      ],
      placeholders: {
        name: "Your name",
        phone: "+998 90 123 45 67",
