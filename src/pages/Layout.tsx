...
export default function Layout() {
  ...
  return (
    <div className={`layout-shell ${isHome ? "home-layout" : "non-home-layout"} flex min-h-screen flex-col ${isHome ? "bg-[#edf2f6]" : "bg-[#ECEAE5] dark:bg-[#07152f]"}`}>
      ...
      <main
        className={[
          ...
          isHome
            ...
            : "bg-[#ECEAE5] text-[#111A34] dark:bg-[#07152f] dark:text-white",
        ].join(" ")}
      >
